import {
  ...
  select_default,
  value_default
} from "./chunk-HXODJ4TO.js";
import {
  compile,
  require_dayjs_min,
  serialize,
  stringify
} from "./chunk-M4P2FN2D.js";
import {
  __commonJS,
  __toESM
...
function locale_default(locale3) {
  ...
  function newFormat(specifier, options) {
    ...
    var fill = specifier.fill, align = specifier.align, sign3 = specifier.sign, symbol = specifier.symbol, zero2 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type3 = specifier.type;
    if (type3 === "n") comma = true, type3 = "g";
    else if (!formatTypes_default[type3]) precision === void 0 && (precision = 12), trim = true, type3 = "g";
    if (zero2 || fill === "0" && align === "=") zero2 = true, fill = "0", align = "=";
    var prefix = (options && options.prefix !== void 0 ? options.prefix : "") + (symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type3) ? "0" + type3.toLowerCase() : ""), suffix = (symbol === "$" ? currencySuffix : /[%p]/.test(type3) ? percent : "") + (options && options.suffix !== void 0 ? options.suffix : "");
...
var renderKatexUnsanitized = async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-7X2AFYWP.js");
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-c83219d4-YVFONO5G.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-50d868cf-SNHVNOL6.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-4f6560a1-JITRSGSB.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-0228fc6a-NAGEQXXT.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-82fe8481-ZZPD5BMR.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-a2739b55-WU2IBJZP.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-8eee0895-SOHMOH3Z.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-a8764435-TI3CK6OZ.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-1e28029f-ZZIMKQTD.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-f5964ef8-PIP63Z7K.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-08caed73-NSQR5XK5.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-c5b8d532-GOQHI4FV.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-beda092f-4VIMY5M4.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-2358418a-G6SGIRTR.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-1ecb1508-25TWXCLV.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-c2b004d7-YXIATJD4.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-c64418c1-74NW6Y3H.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-6af322e1-4VMYGQ4S.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-faaaa080-J5YOKA2I.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-8da855dc-FC6QVE27.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-a04cb91d-I7AJ6JGG.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-c4efeb88-JLCTJ2D7.js");
...
mermaid/dist/mermaid-7ea9cbd6.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KDYCAITL.js.map
